...
function theme_styles() {
	wp_enqueue_style( 'theme-font','<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@400;700&display=swap" rel="stylesheet">',$arrayName = array(), '1.0.0' );
...
function theme_scripts() {
	...
	wp_enqueue_script( 'theme-script',get_template_directory_uri() .'/js/script.css',array( 'jquery' ),'1.0.0' );
}
